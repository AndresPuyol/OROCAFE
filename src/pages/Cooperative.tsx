...
import videoCatacion from '../img/videoCATACION.mp4';
...
import imgYurani from '../img/Auxiliar administrativa.jpg';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-10 overflow-hidden marquee-container-team w-full relative">
            <div className="flex w-max animate-marquee-team py-4">
              {[...Array(4)].flatMap(() => [
                { name: 'Yurani Alexandra Ramos Gomez', role: t('coop.role.admin'), img: imgYurani },
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link to="/productos" className="block cursor-pointer">
              <motion.div
                whileHover={{ y: -10 }}
                className="bg-gold p-10 md:p-12 flex flex-col justify-between rounded-3xl group text-white shadow-sm hover:shadow-xl transition-all min-h-[340px]"
              >
                <div>
            ...
            {/* Nuestra Selección Especial - dark */}
            <Link to="/productos#linea-de-productos" className="block cursor-pointer group">
              <motion.div
                initial={{ opacity: 0, scale: 0.95 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                className="bg-neutral-900 p-10 md:p-12 flex flex-col justify-center relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all min-h-[340px]"
              >
                <div className="absolute top-10 right-10 opacity-10 group-hover:opacity-20 transition-opacity">
                  <Leaf className="w-20 h-20 text-gold group-hover:scale-110 transition-transform duration-300" />
                </div>
                <div className="relative z-10 w-full">
                  <div className="flex justify-between items-start mb-6 gap-2">
                    <h3 className="text-white font-serif font-bold text-3xl leading-tight">{t('coop.spec.main.title')}</h3>
                    <ArrowRight className="text-gold opacity-0 group-hover:opacity-100 transition-all transform -translate-x-4 group-hover:translate-x-0 shrink-0" size={32} />
                  </div>
            ...
            {/* Rainforest - full width */}
            <Link to="/sostenibilidad" className="md:col-span-2 block cursor-pointer group">
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-neutral-50 border border-neutral-100 p-10 md:p-12 flex flex-col md:flex-row items-center gap-12 rounded-3xl shadow-sm group-hover:shadow-xl transition-all"
              >
